...
// Used for real account deletion — purging a user's data needs to reach
// object storage too, not just cascade-delete DB rows, or a deleted
// account's uploaded files would silently linger in the bucket forever.
