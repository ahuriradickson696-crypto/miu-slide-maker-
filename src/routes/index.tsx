    ...
    <div className="min-h-screen bg-[#F7F8F5] flex flex-col">
      ...
      <div className="border-b bg-white/80 backdrop-blur sticky top-0 z-10">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-3 flex items-center gap-3">
          <img src={logo} alt="MIU logo" className="h-8 w-8 object-contain" />
      ...
      <div className="miu-gradient text-white">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 pt-14 sm:pt-20 pb-16 sm:pb-24 text-center">
          <motion.img
            ...
            className="mx-auto h-24 w-24 sm:h-28 sm:w-28 object-contain mb-4"
          />
          <motion.h1
        ...
        <AuthGate serviceName="MIU Studio" onAuthChange={handleAuthChange}>
          <div className="grid sm:grid-cols-2 gap-5">
            ...
            <FeatureCard
              ...
              description="Turn any deck into a multiple-choice or short-answer quiz, ready to export for Moodle, Canvas, or Blackboard. Generate a deck first, then click Quiz from its toolbar."
              cta="Open Slide Studio"
            />
            <ComingSoonCard
      ...
      <footer className="border-t bg-white">
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 pb-6 flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-muted-foreground">
