    ...
    <div className="min-h-screen bg-[#F7F8F5]">
      ...
      <div className="border-b bg-white/90 backdrop-blur sticky top-0 z-10">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          <a href="/quiz" className="inline-flex items-center gap-1.5 text-xs font-medium text-muted-foreground hover:text-primary transition">
...
function CurriculumLibrary() {
  ...
  async function handleFile(file: File) {
    ...
    if (!hasApiAccess) {
      setUploadError("Add an API key in Settings first, then come back here.");
      return;
    }
