  ...
  sections: [
    {
      ...
      paragraphs: ["There are several types of reports.", "Each serves a different purpose."],
      keyTerms: [{ term: "Memorandum", definition: "A short internal report." }],
    },
  ],
...
describe("lectureNotesToMarkdown", () => {
  ...
  it("omits the Further Reading section entirely when empty", () => {
    const withoutReading = lectureNotesToMarkdown({ ...sampleNotes, furtherReading: [] });
